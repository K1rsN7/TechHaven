			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="<?php echo "./img/".$_SESSION['product_id']['image'] ?>" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="<?php echo "./img/".$_SESSION['product_id']['image'] ?>" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3><?php echo $_SESSION['product_id']['name_product'] ?></h3>
						<h2><?php echo $_SESSION['product_id']['price'] ?> ₽</h2>
						<ul class="list">
							<!-- TODO: поправить ссылки -->
							<li><a class="active" href="index.php?page=sort&id_cat=<?php echo $_SESSION['product_id']['id_category']?>"><span>Категории:</span> <?php echo $_SESSION['product_id']['name_category'] ?></a></li>
							<li><a class="active" href="index.php?page=sort&b_ids[]=<?php echo $_SESSION['product_id']['id_brand']?>"><span>Бренд:</span> <?php echo $_SESSION['product_id']['name_brand']?></a></li>
						</ul>
						<p>
							<?php echo $_SESSION['product_id']['description']?>
						</p>
						...
						<div class="card_area d-flex align-items-center">
							<button class="primary-btn" onclick="addToCart(<?php echo $_SESSION['product_id']['id_product']; ?>)">Добавить в корзину</button>
						</div>
